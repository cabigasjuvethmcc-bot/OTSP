...
<section class="hero">
    <div class="container hero-inner">
        <div class="hero-text">
            ...
            <a href="/OTSP/products.php" class="btn-primary">Browse Products</a>
        </div>
...
<section class="categories">
    <div class="container">
        ...
        <div class="category-grid">
            <a href="/OTSP/products.php?category=laptops" class="category-card">Laptops</a>
            <a href="/OTSP/products.php?category=desktops" class="category-card">Desktops</a>
            <a href="/OTSP/products.php?category=components" class="category-card">Components</a>
            <a href="/OTSP/products.php?category=peripherals" class="category-card">Peripherals</a>
        </div>
    </div>
</section>

    ...
    <div class="product-detail-grid">
        <div class="product-detail-image">
            <?php if (!empty($product['image'])): ?>
                <div class="product-image-placeholder large" style="background:#ffffff;padding:0;border:0;">
                    <img src="/OTSP/assets/images/<?php echo htmlspecialchars($product['image']); ?>" alt="<?php echo htmlspecialchars($product['name']); ?>" style="width:100%;height:280px;object-fit:cover;border-radius:0.75rem;" />
                </div>
            <?php else: ?>
